...
#define STD_OUT_BUFFERSIZE 512
#define STD_IN_BUFFERSIZE  64

/**\brief The actual buffers to hold the data of the STDIO pipes */
static char _std_out_buffer[STD_OUT_BUFFERSIZE] __attribute__((aligned (4)));
static char _std_in_buffer[STD_IN_BUFFERSIZE]   __attribute__((aligned (4)));
...
static _std_pipe _eb_monitor_stdout = {STD_OUT_BUFFERSIZE,0,0, _std_out_buffer};
static _std_pipe _eb_monitor_stdin  = {STD_IN_BUFFERSIZE, 0,0, _std_in_buffer };


#ifndef NO_EBMON_INIT
/** \brief If additional initialization is needed then this is the place.
 *         The initialization is done before the first  char written to to STDOUT pipe.
 *
 *
 */
